Datastore is a NoSQL document database built for automatic scaling, high <br> performance, and ease of application development. Datastore features include:<br>
